...
public class Client  {
	...
	private Socket socket;
        ...
        final private String KSpass="keystore1pass";       //kwdikos keystore tou client1
        final private String PrKeypass="client1pass";      //kwdikos privatekey tou client1
        final private String TSpass="truststore1pass";     //kwdikos truststore tou client1
        private  PublicKey PubKeyS;
        private  PrivateKey PrivKey;
	private ClientGUI cg;
	private String server, username;
	private int port;
        final String name="Client1";                 //onoma pou ginetai h anagnwrish apo ton server
	...
	public boolean start() throws NoSuchAlgorithmException, NoSuchPaddingException, KeyStoreException, FileNotFoundException, IOException, CertificateException, UnrecoverableKeyException, ClassNotFoundException {
		...
		display(msg + '\n');
                ...
                ks.load(new FileInputStream("C:\\keystore1.jks"),KSpass.toCharArray());    //fortwsh tou keystore1 sto ks
                cert = (X509Certificate)ks.getCertificate("Client1");     //certificate tou Client1
                PrivKey=(PrivateKey) ks.getKey("Client1", PrKeypass.toCharArray()); //private key tou Client1
                 ks.load(new FileInputStream("C:\\truststore1.jks"),TSpass.toCharArray()); //fortwsh tou truststore tou client1
		...
		try
		{
			...
			sOutput.writeObject(new ChatMessage(username,cert,name));//pername ston server to username,to name,kai to pistopoihtiko tou client1
	 ...
	 */
	void sendMessage(ChatMessage msg) throws InvalidKeyException, IllegalBlockSizeException, BadPaddingException, ClassNotFoundException, NoSuchAlgorithmException, NoSuchPaddingException, SignatureException, CertificateExpiredException, CertificateNotYetValidException {
		try {
	...
	public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException, BadPaddingException, IllegalBlockSizeException, ClassNotFoundException, KeyStoreException, IOException, FileNotFoundException, CertificateException, UnrecoverableKeyException, SignatureException {
		// default values
		int portNumber = 1500;
